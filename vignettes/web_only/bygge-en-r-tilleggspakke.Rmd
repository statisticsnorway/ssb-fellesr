...
knitr::include_graphics("./vignettes/web_only/images/pakke_struktur.png")
```
...
```{r, echo = FALSE, out.width="100%"}
knitr::include_graphics("./vignettes/web_only/images/description.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("./vignettes/web_only/images/frustrated.png")
```
