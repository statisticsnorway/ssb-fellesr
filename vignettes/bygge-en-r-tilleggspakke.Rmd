...
description: |
  Her er et oppskrift til hvordan å bygge en R-tilleggspakke for bruk i SSB.
author:
  - name: Susie Jentoft
    url: {}
date: 2022-06-10
preview: ../../images/postal.png
output:
...
# Tekniske oppsetting
Det er anbefalt å bygge R-pakke i RStudio. Det er lettest å gjøre dette i admin/på PC eller på linux. På linux er alle nødvendig tilleggsverktøy og pakker installerte. **Det er for tida tekniske problemer med å lage pakker i windows i prod. sone.**  
...
knitr::include_graphics("../images/pakke_struktur.PNG")
```
...
```{r, echo = FALSE, out.width="100%"}
knitr::include_graphics("../images/description.png")
```
...
# Sitte fast?
Hvis du sitter fast med et problem med pakke bygging er det veldig sannsynlig at andre på SSB har hatt de samme problem. Ta gjerne kontakt med andre på [Yammer](https://www.yammer.com/ssb.no/#/threads/inGroup?type=in_group&feedId=9481952) 

```{r, echo = FALSE}
knitr::include_graphics("../images/frustrated.png")
```
